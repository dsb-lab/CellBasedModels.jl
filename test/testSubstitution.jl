@testset "Substitution" begin
    ...
    @test substitution(:(id,id),p) == :(identityV[ic1_,1],identityV[ic1_,1])  
    ...
    @test substitution(:(id_new,id_new),p,post="_new",addName="Copy") == :(identityVCopy[ic1_,1],identityVCopy[ic1_,1])  
