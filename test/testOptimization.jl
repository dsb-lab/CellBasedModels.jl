@testset "optimization" begin
    ...
    #Swarm algorithm
    @test begin
        m = AgentBasedModels.Optimization.swarmAlgorithm(simulation,explore,population=10,stopMaxGenerations=50,returnAll=false)
        abs(m.a - 3 ) < .1
    end
    @test begin
        m = AgentBasedModels.Optimization.swarmAlgorithm(simulation,explore,population=10,stopMaxGenerations=50,
    ...
    @test begin
        m = AgentBasedModels.Optimization.beeColonyAlgorithm(simulation,explore,population=10,stopMaxGenerations=50,returnAll=false)
        abs(m.a - 3 ) < .1
    end
    @test begin
        m = AgentBasedModels.Optimization.beeColonyAlgorithm(simulation,explore,population=10,stopMaxGenerations=50,
