"""
    function addUpdateLocal_!(p::AgentCompiled,platform::String)

Generate the functions with the code declared in `UpdateLocal` and adds the code generated to `AgentCompiled`.
