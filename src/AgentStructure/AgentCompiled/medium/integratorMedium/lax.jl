"""
    function addIntegratorMediumLax_!(p::AgentCompiled,platform::String)

Generate the functions related with Medium Update with Lax integration method integration method.
