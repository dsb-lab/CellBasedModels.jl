"""
    function addIntegratorRungeKutta4_!(p::AgentCompiled, platform::String)

Adapts the code declared in `UpdateVariable` to be integrated as the Runge Kutta 4 method and adds the code generated to `AgentCompiled`.
