"""
    function addUpdateGlobal_!(p::AgentCompiled,platform::String)

Generate the functions with the code declared in `UpdateGlobal` and adds the code generated to `AgentCompiled`.
