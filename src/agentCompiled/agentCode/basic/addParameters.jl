...
Generate the arrays to be declared containing the parameters of all the agents and adds the code generated to `Program_`.
...
Generate the functions to update the parameters at each step and adds the code generated to `Program_`.
