...
toBackend(csr::CSRTuple{P,NBlock}, ::KernelAbstractions.GPU) where {P<:GPU,NBlock} = csr
toBackend(csr::CSRTuple{P,NBlock}, ::Type{<:KernelAbstractions.GPU}) where {P<:GPU,NBlock} = csr