...
#Parameters of neighborhoods
    :skin                         => BaseParameter(:Float,   (:Global,),                :Neighbor,    false,       false,     false,    Symbol[:VerletTime,:VerletDistance],  @eval (com,agent) -> Float64[0.]                                                                 ),
    ...
    :neighborList_                => BaseParameter(:Int,     (:Local,:Neighbors),       :Neighbor,    true ,       true,      false,    Symbol[],                             @eval (com,agent) -> if agent.neighbors in [:VerletDistance,:VerletTime]; zeros(Int64,com[:N][1],com[:nMaxNeighbors][1]) else zeros(Int64,0,0); end                                  ),
    :neighborTimeLastRecompute_   => BaseParameter(:Float,   (:Global,),                :Neighbor,    false,       true,      false,    Symbol[],                             @eval (com,agent) -> Float64[0]                                                                ),
    :posOld_                      => BaseParameter(:Float,   (:Local,:Dims),            :Neighbor,    true,        true,      false,    Symbol[],                             @eval (com,agent) -> if agent.neighbors == :VerletDistance; zeros(Float64,com[:N][1],agent.dims) else zeros(Float64,0,agent.dims); end                                          ),
