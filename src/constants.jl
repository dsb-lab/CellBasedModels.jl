...
#Parameters of position
    ...
    :xNew_                        => BaseParameter(:Float,   (:Local,),                 2,          :User,        true,        true,      false,    Symbol[],                                       @eval (com,agent) -> if agent.posUpdated_[1]; zeros(Float64,com[:N][1]) else Float64[] end                                                   ),
    :yNew_                        => BaseParameter(:Float,   (:Local,),                 2,          :User,        true,        true,      false,    Symbol[],                                       @eval (com,agent) -> if agent.posUpdated_[2]; zeros(Float64,com[:N][1]) else Float64[] end                                                   ),
    :zNew_                        => BaseParameter(:Float,   (:Local,),                 2,          :User,        true,        true,      false,    Symbol[],                                       @eval (com,agent) -> if agent.posUpdated_[3]; zeros(Float64,com[:N][1]) else Float64[] end                                                   ),  
...
#Parameters of user declared
    ...
    :mediumNM_                    => BaseParameter(:Float,   (:Medium,),                0,          :User,        false,       true,      false,    Symbol[],                                       @eval (com,agent) -> zeros(Float64,com[:NMedium]...,length(getSymbolsThat(agent.declaredSymbols,:basePar,:mediumNM_))) ),
    :mediumM_                     => BaseParameter(:Float,   (:Medium,),                1,          :User,        false,       true,      false,    Symbol[],                                       @eval (com,agent) -> zeros(Float64,com[:NMedium]...,length(getSymbolsThat(agent.declaredSymbols,:basePar,:mediumM_)))  ),
    :mediumMNew_                  => BaseParameter(:Float,   (:Medium,),                3,          :User,        false,       true,      false,    Symbol[],                                       @eval (com,agent) -> zeros(Float64,com[:NMedium]...,length(getSymbolsThat(agent.declaredSymbols,:basePar,:mediumM_)))  )
)
